...
class Zaikio::Hub::Test < ActiveSupport::TestCase
  ...
  def vendor_token
    "eyJraWQiOiJhNmE1MzFjMGZhZTVlNWE1MDAzZDI2ZTRhMTIwMmIwNjg2ZDFkNTRjNGZhYTViZDlkZTBjMzdkY2JkY2RkYzdlIiwiYWxnIjoiUlMyNTYifQ..C9v4LpegLxi1v1zlY3RtYbnF5Xe0g78sPC1kElN7RYPzIzrbEAEMugwoocpT3YyNy1OoszIV1m2gd26btW9VIYCMz3idJrdG-W0nL1Zbp_qpicU1CVl9PJIzuUCnAavscGkd-sPabjJQO2yQZGAgRlcZt-0aD0uRsUVPDf9RUajAYqIh_iZSqGDnVLgz8XXRSFnht7mDD1c8EvGzLIE5JoLtVRCVJrzeR1wwpHe2QDDeRQA77P0xOOK5S0WY-VCmmdO_6deEgeL2DJpOZSUeoZHsRxhF_e0slH4ZYXOg-EOaenDzcfw1OE_Fj8kae77rWHWPxhaVOJpIQiFwaRXOpA" # rubocop:disable Layout/LineLength
  end
  ...
  test "works for vendor organization" do
    VCR.use_cassette("vendor_organization", record: :new_episodes) do
      Zaikio::Hub.with_token(vendor_token) do
        organization = Zaikio::Hub::CurrentOrganization.new

        connections = organization.connections.per_page(20)
        ...
        assert_equal "keyline", connections.first.app_name

        apps = organization.apps.per_page(20)
        assert_equal "keyline", apps.first.name
        assert_equal "mis_erp", apps.first.category
      end
    end
  end
  ...
  test "create single availability" do
    ...
    stub_request(:post, "https://hub.zaikio.test/api/v1/machines/#{machine_id}/availabilities")
    ...
    Zaikio::Hub.with_token(token) do
      availability = Zaikio::Hub::Machine.new(id: machine_id).availabilities.create(
        mode: "available",
        starts_at: 34_200,
        ends_at: 63_000,
        weekday: "monday",
